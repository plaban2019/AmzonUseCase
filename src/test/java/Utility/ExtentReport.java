...
public class ExtentReport {
    ...
    public void beforeSuite()
    {
        ...
        extent = new ExtentReports("amazon.in_execution_report.html", true); //Provide Desired Report Directory Location and Name
        extent.loadConfig(new File("src/test/java/Utility/ExtentConfig.xml")); //Supporting File for Extent Reporting
        extent.addSystemInfo("Environment","Amazon mobile site"); //It will provide Execution Machine Information
    }
    ...
    public  void beforeMethod(Method method)
    {
        ...
        test.assignCategory("Amazon.in  :: " + "ORT ENV" + " :: APP VERSION - "+ "ver"); //Test Category Defined Here
    }

    public String getScreenShot(RemoteWebDriver driver, String screenshotName, WebElement element) throws Exception {
    ...
    public static String getFailScreenshot(RemoteWebDriver driver, String screenshotName) throws Exception {
        String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
        TakesScreenshot ts = (TakesScreenshot) driver;
        File source = ts.getScreenshotAs(OutputType.FILE);
        //after execution, you could see a folder "FailedTestsScreenshots" under src folder
